      (function () {
        ...
        function poly(pts, cls, extra) {
          ...
          for (var i = 0; i < pts.length; i++) {
            s +=
              (i ? ' ' : '') + pts[i].x.toFixed(1) + ',' + pts[i].y.toFixed(1);
          }
          return (
            '<polygon points="' +
            s +
        ...
        function render() {
          ...
          var A = proj(0, 0, 0),
            ...
            Dp = proj(x, y, z);
          if (DIM >= 2 && y > 0 && x > 0)
            s += line(Cp, proj(0, y, 0), 's-help y-c');
        ...
        function paint() {
          ...
          var t =
            '<span class="p">(</span><span class="cx">' + fa(x) + '</span>';
          if (DIM >= 2)
            t +=
              '<span class="p">،&nbsp;</span><span class="cy">' +
              fa(y) +
              '</span>';
          if (DIM >= 3)
            t +=
              '<span class="p">،&nbsp;</span><span class="cz">' +
              fa(z) +
              '</span>';
